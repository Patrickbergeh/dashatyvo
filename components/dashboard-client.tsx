      ...
      <main className="flex w-full flex-col px-6 py-7 xl:min-h-0 xl:flex-1 xl:py-5">
        ...
        <div className="grid grid-cols-1 gap-6 xl:min-h-0 xl:flex-1 xl:grid-cols-[minmax(0,1fr)_440px_340px]">
          <section className="relative min-w-0 xl:min-h-0 xl:overflow-y-auto xl:pr-1">
            {/* fade no topo: degradê suave claro -> transparente ao rolar */}
            <div className="pointer-events-none sticky top-0 z-10 -mb-16 hidden h-16 bg-gradient-to-b from-bg via-bg/60 to-transparent xl:block" />
